...
#define OnDelay 200000
#define OffDelay 4000000 
...
main(void)
{
    ...
    // Enable, check, and configure GPIO port PM0 (up button) for use.
    ...
    GrStringDrawCentered(&sContext, "General Kenobi", -1,
    ...
    while(1)
    {
      //
        ...
        // Delay for a bit.
        //
        for(ui32Loop = 0; ui32Loop < OnDelay; ui32Loop++)
        {
        }
        ...
        // Delay for a bit.
        //
        for(ui32Loop = 0; ui32Loop < OffDelay; ui32Loop++)
        {
        }
        
        // Check for up-button input and modify text accordingly.
        if (GPIOPinRead(GPIO_PORTM_BASE, GPIO_PIN_0) == 0)
        {
          GrContextFontSet(&sContext, g_psFontCm12);
          GrStringDrawCentered(&sContext, "   Da Button   ", -1,
